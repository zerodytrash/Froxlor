...
class AdminApcuInfo extends FeModule
{
	 ...
	 * @var int
	 */
	private $horizontal_bar_size = 950;
	...
	public function delete()
	{
		...
		// check for apcu-stuff
		if (! function_exists('apcu_clear_cache')) {
			\Froxlor\UI\Response::standard_error('no_apcuinfo');
		}
		apcu_clear_cache();
		\Froxlor\FroxlorLogger::getLog()->addInfo("cleared APCu cache");
		\Froxlor\UI\Response::redirectTo("index.php?module=AdminApcuInfo");
	}

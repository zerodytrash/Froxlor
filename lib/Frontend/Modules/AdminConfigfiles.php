...
class AdminConfigfiles extends FeModule
{
	...
	public function overview()
	{
		...
		if ($distribution != "") {
			...
			// get distro-info
			$dist_display = $this->getCompleteDistroName($configfiles);
	...
	public function setconfigured()
	{
		...
		\Froxlor\UI\Response::redirectTo('index.php?module=AdminConfigfiles');
	}
	...
	private function getFileContentContainer($file_content, &$replace_arr, $realname, $distro_editor)
	{
		$files = "";

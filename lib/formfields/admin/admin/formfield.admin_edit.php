	...
	'admin_edit' => array(
		...
		'sections' => array(
			'section_a' => array(
				...
				'fields' => array(
					...
					'admin_password_suggestion' => array(
						...
						'visible' => (\Froxlor\Settings::Get('panel.password_regex') == '' && ($result['adminid'] == \Froxlor\CurrentUser::getField('userid') ? false : true)),
						'readonly' => true
					),
					'def_language' => array(
			...
			'section_c' => array(
				...
				'visible' => ($result['adminid'] != \Froxlor\CurrentUser::getField('userid') ? true : false),
				'fields' => array(
					'ipaddress' => array(

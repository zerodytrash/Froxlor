		...
		'sections' => array(
			...
			'section_bssl' => array(
				...
				'fields' => array(
					...
					'override_tls' => array(
						'visible' => (($ssl_ipsandports != '' ? true : false) && \Froxlor\CurrentUser::getField('change_serversettings') == '1' ? true : false),
					...
					'ssl_protocols' => array(
						'visible' => (($ssl_ipsandports != '' ? true : false) && \Froxlor\CurrentUser::getField('change_serversettings') == '1' && \Froxlor\Settings::Get('system.webserver') != 'lighttpd' ? true : false),
					...
					'tlsv13_cipher_list' => array(
						'visible' => (($ssl_ipsandports != '' ? true : false) && \Froxlor\CurrentUser::getField('change_serversettings') == '1' && \Froxlor\Settings::Get('system.webserver') == "apache2" && \Froxlor\Settings::Get('system.apache24') == 1 ? true : false),

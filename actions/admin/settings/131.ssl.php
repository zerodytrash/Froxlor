...
return array(
	'groups' => array(
		'ssl' => array(
			'title' => \Froxlor\Frontend\UI::getLng('admin.sslsettings'),
			'fields' => array(
				'system_ssl_enabled' => array(
					'label' => \Froxlor\Frontend\UI::getLng('serversettings.ssl.use_ssl'),
					'settinggroup' => 'system',
					'varname' => 'use_ssl',
					'type' => 'bool',
					'default' => false,
				...
				'system_ssl_protocols' => array(
					'label' => \Froxlor\Frontend\UI::getLng('serversettings.ssl.ssl_protocols'),
					'settinggroup' => 'system',
				...
				'system_ssl_cipher_list' => array(
					'label' => \Froxlor\Frontend\UI::getLng('serversettings.ssl.ssl_cipher_list'),
					'settinggroup' => 'system',
				...
				'system_ssl_cert_file' => array(
					'label' => \Froxlor\Frontend\UI::getLng('serversettings.ssl.ssl_cert_file'),
					'settinggroup' => 'system',
				...
				'system_ssl_key_file' => array(
					'label' => \Froxlor\Frontend\UI::getLng('serversettings.ssl.ssl_key_file'),
					'settinggroup' => 'system',
				...
				'system_ssl_cert_chainfile' => array(
					'label' => \Froxlor\Frontend\UI::getLng('admin.ipsandports.ssl_cert_chainfile'),
					'settinggroup' => 'system',
				...
				'system_ssl_ca_file' => array(
					'label' => \Froxlor\Frontend\UI::getLng('serversettings.ssl.ssl_ca_file'),
					'settinggroup' => 'system',
					'varname' => 'ssl_ca_file',
					'type' => 'string',
					'string_type' => 'file',
				...
				'system_apache24_ocsp_cache_path' => array(
					'label' => \Froxlor\Frontend\UI::getLng('serversettings.ssl.apache24_ocsp_cache_path'),
					'settinggroup' => 'system',
				...
				'system_letsencryptacmeconf' => array(
					'label' => \Froxlor\Frontend\UI::getLng('serversettings.letsencryptacmeconf'),
					'settinggroup' => 'system',
				...
				'system_leapiversion' => array(
					'label' => \Froxlor\Frontend\UI::getLng('serversettings.leapiversion'),
					'settinggroup' => 'system',
				...
				'system_letsencryptca' => array(
					'label' => \Froxlor\Frontend\UI::getLng('serversettings.letsencryptca'),
					'settinggroup' => 'system',
				...
				'system_letsencryptreuseold' => array(
					'label' => \Froxlor\Frontend\UI::getLng('serversettings.letsencryptreuseold'),
					'settinggroup' => 'system',

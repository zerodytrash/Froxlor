...
$lng['panel']['mysqls'] = 'MySQL-databases';
$lng['panel']['emails'] = 'Email-addresses';
$lng['panel']['email_accounts'] = 'Email-accounts';
$lng['panel']['email_forwarders'] = 'Email-forwarders';
$lng['panel']['ftps'] = 'FTP-accounts';
$lng['panel']['subdomains'] = 'Subdomains';
$lng['panel']['domains'] = 'Domains';
...
$lng['update']['update_information']['part_b'] = 'Customers will not be able to log in until the update has been finished.<br /><strong>Proceed?</strong>';
...
$lng['serversettings']['apache_24']['description'] = '<strong class="text-danger">ATTENTION:</strong> use only if you acutally have apache version 2.4 or higher installed<br />otherwise your webserver will not be able to start';
...
$lng['serversettings']['customerssl_directory']['description'] = 'Where should customer-specified ssl-certificates be created?<br /><br /><div class="text-danger">NOTE: This folder\'s content gets deleted regulary so avoid storing data in there manually.</div>';
...
$lng['2fa']['2fa_added'] = '2FA activated successfully';
